...
TEST(tests_operators_mul_matrix, correct_arg) {
  ...
  answer.Assign({-38, -45, -54, -106, -121, -157, -303, -377, -494});
...
TEST(tests_operators_mul_matrix, correct_arg_3) {
  ...
  answer.Assign({26, 154, 174, 152, 121, 152, 17, 155, 126, 144, 102, 155});
...
TEST(tests_operators_mul_matrix, correct_arg_4) {
  ...
  answer.Assign({576, 945, 774, 378, 675, 477, 261, 810, 819});
...
TEST(tests_operators_mul_matrix, correct_arg_6) {
  ...
  answer.Assign({6, 5, 4, 51, 44, 37, 96, 83, 70});
...
TEST(tests_operators_mul_matrix, correct_arg_7) {
  ...
  answer.Assign({6, 5, 4, 7, 51, 44, 37, 49, 96, 83, 70, 91});
...
TEST(tests_operators_mult_matrix_number, correct_arg_3) {
  ...
  matrix.Assign({5, 34, -4, 844.545, -0.452434, 87});
...
TEST(tests_operators_mult_matrix_number, correct_arg_6) {
  ...
  matrix.Assign({0.25, 1.25, 2.25, 3.25, 4.25, 5.25, 6.25, 7.25, 8.25});

  answer.Assign({1, 5, 9, 13, 17, 21, 25, 29, 33});
